      ...
      <tr bgcolor="#000000">
        <td><table border="0" width="600" height="440" cellspacing="0" cellpadding="0">
          <tr bgcolor="#ffffff" height="50">
            <td height="50"><?php echo file_exists(DIR_WS_IMAGES . 'header_logo.gif')?tep_image(DIR_WS_IMAGES . 'header_logo.gif', STORE_NAME, '', '50'):tep_image(DIR_WS_IMAGES . 'oscommerce.gif', 'osCommerce', '204', '50'); ?></td>
