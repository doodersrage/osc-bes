...
$OutFile = DIR_FS_CATALOG."feeds/".BIZRATE_FILENAME; 
...
AND products.products_status != 0 AND categories.categories_status != 0
ORDER BY
...
//"Category \t Mfr \t Title \t Description \t Link \t Image \t SKU \t # on Hand \t Condition \t Ship. Weight \t Ship. Cost \t Bid \t Promo Des. \t Other \t Price\n";
	...
	tep_href_link(FILENAME_PRODUCT_INFO, $row->product_url) . "\t" .
	$row->image_url . "\t" .
	$row->id . "\t" .
