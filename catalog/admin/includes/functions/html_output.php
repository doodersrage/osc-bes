...
// added by splautz to add counter and spellchecker link
  function spellcount_link($formname, $fieldname, $int=NULL) {
    $ret = '<span class="spellcount"><a href="spellcheck.php?init=nojs" class="spellcount" onclick="javascript:SpellCheck('."'$formname','$fieldname'".');return false;">SpellCheck</a>';
    if (is_numeric($int)) $ret .= '&nbsp;&nbsp;&nbsp;Count:&nbsp;</span><span id="'.$fieldname.'-count" class="spellcount">'.$int;
    $ret .= '</span>';
    return $ret;
  }
