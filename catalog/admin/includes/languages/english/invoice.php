...
define('STORE_URL_ADDRESS', HTTP_CATALOG_SERVER); // Your web address Printed at the bottom of your invoices
...
define('INVOICE_IMAGE_ALT_TEXT', 'Click HERE to
Display or Hide
the Order Comments box below for printing'); // Change this to your logo's ALT text or leave blank
?>