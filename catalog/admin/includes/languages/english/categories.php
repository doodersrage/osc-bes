...
define('TEXT_CATEGORIES_SORT_ORDER', 'Sort Order:');
define('TEXT_CATEGORIES_STATUS', 'Category Status:');
define('TEXT_CATEGORIES_IMAGE', 'Category Image:');
define('TEXT_CATEGORIES_IMG_ALT', 'Category Img Alt Text:');
define('TEXT_CATEGORIES_DPIDS', 'Displayed Products:');
define('TEXT_CATEGORIES_PRANGES', 'Price Ranges for Search:');
define('TEXT_CATEGORIES_INTRO', 'Category Title/Intro Text:');
define('TEXT_CATEGORIES_BODY', 'Category Body Text:');
define('TEXT_CATEGORIES_BODY2', 'Category Footer Text:');
define('TEXT_CATEGORIES_METTA_INFO', '<b>Meta Tag/SEO Information</b>');
define('TEXT_CATEGORIES_HEAD_TITLE', 'Category Header Title:');
define('TEXT_CATEGORIES_HEAD_DESCRIPTION', 'Category Header Desc:');
define('TEXT_CATEGORIES_HEAD_KEYWORDS', 'Category Header Keywords:');
define('TEXT_CATEGORIES_NAME_URL', 'Category URL Name:');
define('TEXT_CATEGORIES_H1', 'Category H1 Line:');
...
define('TEXT_PRODUCTS_INFO', 'Product Short Info:');
...
define('TEXT_PRODUCTS_IMG_ALT', 'Product Img Alt Text:');
define('TEXT_PRODUCTS_URL', 'Product URL:');
define('TEXT_PRODUCTS_URL_WITHOUT_HTTP', '<small>(without http://)</small>');
define('TEXT_PRODUCTS_AFFILIATE_URL', 'Product Affiliate Link:');
define('TEXT_PRODUCTS_PRICE_NET', 'Product Price (Net):');
define('TEXT_PRODUCTS_PRICE_GROSS', 'Product Price (Gross):');
define('TEXT_PRODUCTS_SPECIAL_STATUS', 'Special Price Status:');
define('TEXT_PRODUCTS_SPECIAL_PRICE_NET', 'Special Price (Net):');
define('TEXT_PRODUCTS_SPECIAL_PRICE_GROSS', 'Special Price (Gross):');
define('TEXT_PRODUCTS_SPECIALS_XDATE', 'Special Price Expiry Date:');
define('TEXT_PRODUCTS_WEIGHT', 'Product Weight:');
define('TEXT_PRODUCTS_FREE_SHIPPING', 'Free shipping:');
define('TEXT_PRODUCTS_ORIGIN_POSTCODE','Product Origin Post Code:');
define('TEXT_PRODUCTS_FREIGHT_CLASS','Product NMFC(50-500) & # pieces:');
define('TEXT_PRODUCTS_SUN_CLASS','Sun Standard Weight Class:');
define('TEXT_PRODUCT_METTA_INFO', '<b>Meta Tag/SEO Information</b>');
define('TEXT_PRODUCTS_HEAD_TITLE', 'Product Header Title:');
define('TEXT_PRODUCTS_HEAD_DESCRIPTION', 'Product Header Desc:');
define('TEXT_PRODUCTS_HEAD_KEYWORDS', 'Product Header Keywords:');
define('TEXT_PRODUCTS_NAME_URL', 'Product URL Name:');
define('TEXT_PRODUCTS_H1', 'Product H1 Line:');
...
define('TEXT_PRODUCTS_SPECIALS', 'Product Specials Status:');
?>
