...
// added by splautz for company sorting, display email, & send new password
define('TABLE_HEADING_NAME', 'Name (last, first)');
define('TABLE_HEADING_COMPANY', 'Company');
define('TEXT_EMAIL_ADDRESS', 'Email Address:');
define('TEXT_SEND_PASSWORD', 'Send new password');
