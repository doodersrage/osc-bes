<?php
/*
  $Id: products_options.php, ver 2.0 10/31/2005 Exp $
...
define('HEADING_TITLE_OPT', 'Images');
define('HEADING_TITLE_VAL', 'Option Values');
define('HEADING_TITLE_ATRIB', 'Images');

define('TABLE_HEADING_ID', 'ID');
define('TABLE_HEADING_NAME', '%s Name');
define('TABLE_HEADING_IMAGE', 'Image');
define('TABLE_HEADING_ALT', 'ALT Text');
