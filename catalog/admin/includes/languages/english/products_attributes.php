...
define('TABLE_HEADING_OPT_SORT_ORDER', 'Sort'); // added for Attribute Sort/Copy
...
// added for Attribute Sort/Copy
define('TEXT_OPTION_SORT', 'Sort #');
define('TEXT_OPTION_SORT_BY', 'Sort by:');
define('TEXT_VALUE_ALL', 'All');
define('TEXT_VALUE_FILTER', 'Filter:');
define('TEXT_ATTRIBUTE_ALL', 'All');
define('TEXT_ATTRIBUTE_FILTER', 'Filter:');
?>