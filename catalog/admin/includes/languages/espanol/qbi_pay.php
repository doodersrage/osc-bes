...
// Headings
define('PAY_METHOD', 'Métido de Quickbooks');
define('PAY_TYPE', 'Tipo');
// Messages
define('PAY_NOT_PAID', 'No prepagado');
define('PAY_PRE_PAID', 'Pagado en linia');
// Buttons
define('PAY_TYPE_BUTTON', 'Actualizar Tipos de Pago');

define('SETUP_FAIL', 'Ningún tipo de pago encontrado en el archivo iif!');
?>