...
// Headings
define('DISC_OTHC', 'Cargos de Quickbooks');
define('DISC_DISC', 'Descuentos de Quickbooks');

define('SETUP_FAIL', 'Ningún tipo de descuenta o cargo encontrado en el archivo iif!');
?>