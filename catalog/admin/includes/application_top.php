...
// added by splautz to redirect to correct url if need be
  if (!strstr(HTTP_SERVER,(getenv('HTTPS')?'https://':'http://').getenv('HTTP_HOST'))) tep_redirect(HTTP_SERVER.getenv('REQUEST_URI'));
