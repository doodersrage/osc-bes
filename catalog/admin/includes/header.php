...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td><?php if (file_exists(DIR_WS_IMAGES . 'header_logo.gif')) echo tep_image(DIR_WS_IMAGES . 'header_logo.gif', STORE_NAME, '', '50');
              elseif (file_exists(DIR_WS_IMAGES . 'header_logo.jpg')) echo tep_image(DIR_WS_IMAGES . 'header_logo.jpg', STORE_NAME, '', '50');
              else echo tep_image(DIR_WS_IMAGES . 'oscommerce.gif', 'osCommerce', '204', '50'); ?></td>
