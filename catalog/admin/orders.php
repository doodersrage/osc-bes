...
/*
  ...
  modified for use with Order Editor
...
// added for Admin Only comments
  if ($action == 'update_order' && isset($HTTP_POST_VARS['admin_only']) && ($HTTP_POST_VARS['admin_only'] == 'on')) $action = 'update_admin_comments';
...
// BOF Admin Only Comments Box v1.2
      case 'update_admin_comments':
		...
		tep_db_query("insert into " . TABLE_ADMIN_COMMENTS . " (orders_id, date_added, comments) values ('" . (int)$oID . "', now(), '" . tep_db_input($comments)  . "')");
...
?>
      <tr>
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading"><?php echo HEADING_TITLE . ($action == 'edit' ? '&nbsp;(' . HEADING_TITLE_NUMBER . $oID . HEADING_TITLE_DATE . tep_datetime_short($order->info['date_purchased']) . ')' : ''); ?></td>
            <td class="pageHeading" align="right"><?php echo tep_draw_separator('pixel_trans.gif', 1, HEADING_IMAGE_HEIGHT); ?></td>
<?php
//begin PayPal_Shopping_Cart_IPN
// modified for order editor
...
?>
    <td class="pageHeading" align="right"><?php echo '<a href="' . tep_href_link(FILENAME_EDIT_ORDERS, 'oID=' . $HTTP_GET_VARS['oID']) . '">' . tep_image_button('button_edit.gif', IMAGE_EDIT) . '</a> <a href="' . tep_href_link(FILENAME_ORDERS_INVOICE, 'oID=' . $HTTP_GET_VARS['oID']) . '" TARGET="_blank">' . tep_image_button('button_invoice.gif', IMAGE_ORDERS_INVOICE) . '</a> <a href="' . tep_href_link(FILENAME_ORDERS_PACKINGSLIP, 'oID=' . $HTTP_GET_VARS['oID']) . '" TARGET="_blank">' . tep_image_button('button_packingslip.gif', IMAGE_ORDERS_PACKINGSLIP) . '</a> <a href="' . tep_href_link(FILENAME_PAYPAL, tep_get_all_get_params(array('action','oID','referer'))) . '">' . tep_image_button('button_back.gif', IMAGE_BACK) . '</a> '; ?></td>
<?php
} else {
...
?>
          ...
          <tr>
            <td><table border="1" cellspacing="0" cellpadding="5">
              <tr> 
                <td class="smallText" align="center"><b><?php echo TABLE_HEADING_DATE_ADDED; ?></b></td>
                <td class="smallText" align="center"><b><?php echo TABLE_HEADING_ADMIN_COMMENTS; ?></b></td>
              </tr>
                          <?php
// BOF Admin Only Comments Box v1.0
    $admin_comments_query = tep_db_query("select orders_id, date_added, comments from " . TABLE_ADMIN_COMMENTS . " where orders_id = '" . tep_db_input($oID) . "' order by date_added");
...
// EOF Admin Only Comments Box v1.0
?>
            </table></td>
          <tr>
          <tr>
                ...
                <td><table border="0" cellspacing="0" cellpadding="2">
                  <tr>
                    <td><table border="0" cellspacing="0" cellpadding="2">
                      ...
                      <tr>
                       <td class="main"><b><?php echo ENTRY_ADMIN_ONLY; ?></b> <?php echo tep_draw_checkbox_field('admin_only', '', false); ?>&nbsp;<?php echo ENTRY_ADMIN_ONLY2; ?></td>
                      </tr>
                    </table></td>
...
<?php
//begin PayPal_Shopping_Cart_IPN
// added 'edit orders' button
if (strtolower($order->info['payment_method']) == 'paypal' && isset($HTTP_GET_VARS['referer']) && $HTTP_GET_VARS['referer'] == 'ipn'){
?>
        <td colspan="2" align="right"><?php echo '<a href="' . tep_href_link(FILENAME_EDIT_ORDERS, 'oID=' . $HTTP_GET_VARS['oID']) . '">' . tep_image_button('button_edit.gif', IMAGE_EDIT) . '</a> <a href="' . tep_href_link(FILENAME_ORDERS_INVOICE, 'oID=' . $HTTP_GET_VARS['oID']) . '" TARGET="_blank">' . tep_image_button('button_invoice.gif', IMAGE_ORDERS_INVOICE) . '</a> <a href="' . tep_href_link(FILENAME_ORDERS_PACKINGSLIP, 'oID=' . $HTTP_GET_VARS['oID']) . '" TARGET="_blank">' . tep_image_button('button_packingslip.gif', IMAGE_ORDERS_PACKINGSLIP) . '</a> <a href="' . tep_href_link(FILENAME_PAYPAL, tep_get_all_get_params(array('action','oID','referer'))) . '">' . tep_image_button('button_back.gif', IMAGE_BACK) . '</a>'; ?></td>
<?php
} else {
?>
...
//  } elseif (isset($HTTP_GET_VARS['status'])) {  // modified by order editor
 // Update 051113
...
<!-- ########## Ajout/editer commande et compte client ########## //-->
                <td class="dataTableContent" align="center"><?php echo '<a href="' . tep_href_link(FILENAME_EDIT_ORDERS, tep_get_all_get_params(array('oID', 'action')) . 'oID='. $orders['orders_id']) . '">' . tep_image(DIR_WS_ICONS . 'preview.gif', ICON_PREVIEW) . '</a>'  ?></td>
<!-- ########## END - Ajout/editer commande et compte client ########## //-->
