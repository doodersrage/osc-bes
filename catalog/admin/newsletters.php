...
// MaxiDVD Added WYSIWYG HTML Area Box + Admin Function v1.7 - 2.2 MS2 Products Description HTML - Head
        ...
        _script_name = "<?php echo ((HTML_AREA_WYSIWYG_BASIC_NEWSLETTER == 'Basic') ? 'editor_basic.js' : 'editor_advanced.js'); ?>";  // script name of editor to use
      ...
      <tr><?php echo tep_draw_form('newsletter', FILENAME_NEWSLETTERS, (isset($HTTP_GET_VARS['page']) ? 'page=' . $HTTP_GET_VARS['page'] . '&' : '') . 'action=' . $form_action); if ($form_action == 'update') echo tep_draw_hidden_field('newsletter_id', $nID); ?>
        <td><table border="0" cellspacing="0" cellpadding="2">
          ...
          <tr>
            ...
            <td class="main"><?php echo tep_draw_input_field('title', $value=$nInfo->title, 'onKeyUp="CountInput(this);"', true);
            echo "<br>".spellcount_link('newsletter','title',strlen($value)); ?></td>
          </tr>
          <tr>
            <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
          <tr>
            ...
            echo "<br>".spellcount_link('newsletter','content'); ?></td>

<?php if ($wysiwyg && HTML_AREA_WYSIWYG_DISABLE_NEWSLETTER == 'Enable') { ?>
