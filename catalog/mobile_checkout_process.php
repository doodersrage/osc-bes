...
// lets start with the email confirmation
  $email_order = STORE_NAME . "\n" . 
                 ...
                 EMAIL_TEXT_INVOICE_URL . ' ' . tep_mobile_link(FILENAME_ACCOUNT_HISTORY_INFO, 'order_id=' . $insert_id, 'SSL', false) . "\n" .
...
// unregister session variables used during checkout
  ...
  tep_redirect(tep_mobile_link(FILENAME_CHECKOUT_SUCCESS, '', 'SSL'));
?>
