      ...
      <tr>
        <td>
      	<table border="0" width="100%" cellspacing="0" cellpadding="2">
	    	  <tr>
    	    	<td class="main" colspan="2"><b><?php echo CATEGORY_PERSONAL; ?></b></td>
...
?>
              <tr>
                <td class="main"><?php echo ENTRY_GENDER . '&nbsp;' . (tep_not_null(ENTRY_GENDER_TEXT) ? '<span class="inputRequirement">' . ENTRY_GENDER_TEXT . '</span>': ''); ?></td>
                <td class="main"><?php echo tep_draw_radio_field('gender', 'm') . '&nbsp;&nbsp;' . MALE . '&nbsp;&nbsp;' . tep_draw_radio_field('gender', 'f') . '&nbsp;&nbsp;' . FEMALE; ?></td>
              </tr>
<?php
  }
?>
              <tr>
                ...
                <td class="main"><?php echo tep_draw_input_field('firstname','','class="input"'); ?></td>
              </tr>
              <tr>
                ...
                <td class="main"><?php echo tep_draw_input_field('lastname'); ?></td>
              </tr>
<?php
  if (ACCOUNT_DOB == 'true') {
?>
...
?>
              <tr>
                ...
                <td class="main"><?php echo tep_draw_input_field('street_address'); ?></td>
              </tr>
<?php
...
?>
              <tr>
                ...
                <td class="main"><?php echo tep_draw_input_field('suburb'); ?></td>
              </tr>
<?php
  }
?>
...
?>
              <tr>
                <td class="main"><?php echo ENTRY_STATE; 
...
?>
              ...
              <tr>
                <td class="main"><?php echo ENTRY_FAX_NUMBER . '&nbsp;' . (tep_not_null(ENTRY_FAX_NUMBER_TEXT) ? '<span class="inputRequirement">' . ENTRY_FAX_NUMBER_TEXT . '</span>': ''); ?></td>
                <td class="main"><?php echo tep_draw_input_field('fax'); ?></td>
              </tr>
		      <tr>
        		<td class="main" colspan="3"><b><?php echo CATEGORY_PASSWORD; ?></b></td>
      		  </tr>
              <tr>
		      ...
		      <tr>
		        <td class="main" colspan="3"><b><?php echo CATEGORY_OPTIONS; ?></b></td>
		      </tr>
              <tr>
                <td class="main"><?php echo ENTRY_NEWSLETTER . '&nbsp;' . (tep_not_null(ENTRY_NEWSLETTER_TEXT) ? '<span class="inputRequirement">' . ENTRY_NEWSLETTER_TEXT . '</span>': ''); ?></td>
                <td class="main"><?php echo tep_draw_checkbox_field('newsletter', '1'); ?></td>
              </tr>
            </table>
          </td>
      </tr>
      ...
      <tr>
        <td align="left"><?php echo tep_mobile_button(IMAGE_BUTTON_CONTINUE); ?></td>
      </tr>
      <tr>
