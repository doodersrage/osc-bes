<?php
/*
  $Id: TransactionDetails.class.php,v 1.1.1.1 2004/09/22 13:45:13 devosc Exp $
...
class PayPal_TransactionDetails {
  ...
  function setMySQLPaymentTable($tablename) {
    $this->paymentTableName = $tablename;
  }
  ...
  function simpleQuery($paypal_id) {
    ...
    $ipn_query = tep_db_query("select " . implode(',',array_merge($info,$txn)) . " from " . $this->paymentTableName . " where paypal_id = '" . (int)$paypal_id . "'");
