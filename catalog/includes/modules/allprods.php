...
/*
  ...
  All Products v3.0 MS 2.2 with Images http://www.oscommerce.com/community/contributions,1501 
    ...
    $row = 0;
     ...
     while ($listing = tep_db_fetch_array($listing_query)) {
      ...
      if (PRODUCT_LIST_IMAGE > 0) {
       if (isset($HTTP_GET_VARS['manufacturers_id'])) {
        $str['image'] = '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'manufacturers_id=' . $HTTP_GET_VARS['manufacturers_id'] . '&products_id=' . $listing['products_id']) . '">' . tep_image(DIR_WS_IMAGES . $listing['products_image'], $listing['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '<br>';
       } else {
