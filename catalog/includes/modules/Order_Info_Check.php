...
<?php
  if ($is_read_only) {
    ...
    echo tep_draw_input_field('firstname', (tep_not_null($account['entry_firstname'])?$account['entry_firstname']:$_SESSION['pp_firstname'])) . '&nbsp;' . ENTRY_FIRST_NAME_TEXT;
  }
?></td>
          </tr>
          <tr>
...
<?php
  if ($is_read_only) {
    ...
    echo tep_draw_input_field('lastname', (tep_not_null($account['entry_lastname'])?$account['entry_lastname']:$_SESSION['pp_lastname'])) . '&nbsp;' . ENTRY_LAST_NAME_TEXT;
  }
?></td>
          </tr>
<?php
...
<?php
  if ($is_read_only) {
    ...
    echo tep_draw_input_field('email_address', (tep_not_null($account['entry_email_address'])?$account['entry_email_address']:$_SESSION['pp_email'])) . '&nbsp;' . ENTRY_EMAIL_ADDRESS_TEXT;
  }
?></td>
          </tr>
        </table></td>
...
<?php
    if ($is_read_only) {
      ...
      echo tep_draw_input_field('company', (tep_not_null($account['entry_company'])?$account['entry_company']:$_SESSION['pp_business'])) . '&nbsp;' . ENTRY_COMPANY_TEXT;
    }
?></td>
          </tr>
        </table></td>
...
<?php
  if ($is_read_only) {
    ...
    echo tep_draw_input_field('street_address', (tep_not_null($account['entry_street_address'])?$account['entry_street_address']:($_SESSION['pp_street1'].((ACCOUNT_SUBURB == 'true')?'':(' '.$_SESSION['pp_street2']))))) . '&nbsp;' . ENTRY_STREET_ADDRESS_TEXT;
  }
?></td>
          </tr>
<?php
...
<?php
    if ($is_read_only) {
      ...
      echo tep_draw_input_field('suburb', (tep_not_null($account['entry_suburb'])?$account['entry_suburb']:$_SESSION['pp_street2'])) . '&nbsp;' . ENTRY_SUBURB_TEXT;
    }
?></td>
          </tr>
<?php
...
<?php
  if ($is_read_only) {
    ...
    echo tep_draw_input_field('city', (tep_not_null($account['entry_city'])?$account['entry_city']:$_SESSION['pp_city'])) . '&nbsp;' . ENTRY_CITY_TEXT;
  }
?></td>
          </tr>
<?php
...
<?php
    ...
    if ($is_read_only) {
      ...
      echo tep_draw_input_field('state', tep_get_zone_name($account['entry_country_id'], $account['entry_zone_id'], (tep_not_null($account['entry_state'])?$account['entry_state']:$_SESSION['pp_state']))) . '&nbsp;' . ENTRY_STATE_TEXT;
    }
?></td>
          </tr>
<?php
...
<?php
  if ($is_read_only) {
    ...
    echo tep_draw_input_field('postcode', (tep_not_null($account['entry_postcode'])?$account['entry_postcode']:$_SESSION['pp_zip'])) . '&nbsp;' . ENTRY_POST_CODE_TEXT;
  }
?></td>
          </tr>
...
<?php
  if ($is_read_only) {
    ...
    echo tep_get_country_list('country', (tep_not_null($account['entry_country_id'])?$account['entry_country_id']:$_SESSION['pp_country'])) . '&nbsp;' . ENTRY_COUNTRY_TEXT;
  }
?></td>
          </tr>
...
<?php
  if ($is_read_only) {
    ...
    echo tep_draw_input_field('telephone', (tep_not_null($account['entry_telephone'])?$account['entry_telephone']:$_SESSION['pp_phone'])) . '&nbsp;' . ENTRY_TELEPHONE_NUMBER_TEXT;
  }
?></td>
          </tr>
          <tr>
