...
// class methods
    function quote($method = '') {
      global $order, $total_count, $shipping_weight_x, $shipping_num_boxes_x, $shipping_count_x, $cart;

      $total_count = $shipping_count_x[1];  // added by splautz for free shipping
      $this->quotes = array('id' => $this->code,
                            'module' => MODULE_SHIPPING_ITEM_TEXT_TITLE,
                            'methods' => array(array('id' => $this->code,
                                                     'title' => MODULE_SHIPPING_ITEM_TEXT_WAY,
                                                     'cost' => (MODULE_SHIPPING_ITEM_COST * $total_count) + ($shipping_num_boxes_x[1]?MODULE_SHIPPING_ITEM_HANDLING:0))));  // modified by splautz for free shipping
