...
// class constructor
    function flat() {
      ...
      $this->enabled = ((MODULE_SHIPPING_FLAT_STATUS == 'True') ? true : true);
...
// class methods
    function quote($method = '') {
      global $order, $shipping_weight_x, $shipping_num_boxes_x;

      $this->quotes = array('id' => $this->code,
                            'module' => MODULE_SHIPPING_FLAT_TEXT_TITLE,
                            'methods' => array(array('id' => $this->code,
                                                     'title' => MODULE_SHIPPING_FLAT_TEXT_WAY,
                                                     'cost' => ($shipping_num_boxes_x[1]?MODULE_SHIPPING_FLAT_COST:0))));  // modified by splautz for free shipping
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Shipping Cost', 'MODULE_SHIPPING_FLAT_COST', '500.00', 'The shipping cost for all orders using this shipping method.', '6', '0', now())");
