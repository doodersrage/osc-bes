          ...
          switch ($column_list[$col]) {
            case 'LINK_LIST_TITLE':
              if (LINKS_TITLES_AS_LINKS == 'True')
                echo '<tr><td height="10">&nbsp;</td></tr><tr><td class="main"><b>',$listing['links_title'].'</b></td></tr>';
              else
                echo '<tr><td height="10">&nbsp;</td></tr><tr><td class="main"><b><a href="' . tep_get_links_url($listing['links_id']) . '" target="_blank">' . $listing['links_title'] . '</a></b></td></tr>';
              break;
            case 'LINK_LIST_URL':
              echo '<tr><td class="main"><a href="' . tep_get_links_url($listing['links_id']) . '" target="_blank">' . $listing['links_url'] . '</a></td></tr>';
              break;
            case 'LINK_LIST_DESCRIPTION':
              echo '<tr><td class="main">' .$listing['links_description'] . '</td></tr>';
              break;
            ...
            case 'LINK_LIST_COUNT':
              echo '<tr><td class="main">'. $listing['links_clicked'].'</td></tr>';        
              break;
        }
      }
    }
