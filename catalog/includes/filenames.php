...
// define the filenames used in the project
  ...
  define('FILENAME_SITEMAP', 'sitemap.php');   // sitemap -> derived from all products
  define('FILENAME_PAGES', 'pages.php');
  define('FILENAME_REVIEW_NOTICE', 'review_notice.php');
// PWA  
  define('FILENAME_PWA_PWA_LOGIN', 'login_pwa_optional.php');
...
// Template Invoicing
  define('FILENAME_PRINT_INVOICE', 'popup_print_invoice.php');
