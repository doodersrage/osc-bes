...
// Wishlist
define('HEADER_TITLE_WISHLIST_CONTENTS', 'Wishlist');
...
define('BOX_HEADING_PRANGES', 'Display by Price');
define('TEXT_PRANGES','Select price range for %s.');

// BOF: WebMakers.com Added: Column Banner
define('BOX_HEADING_COLUMN_BANNER','');
...
define('IMAGE_BUTTON_PRINT_ORDER', 'Print Order');  // added by splautz
...
// multiple orders
define('TEXT_PAID_WITH', 'Paid with order no. ');

//define('MODULE_HEADING_PRODUCT_LISTING', 'Products');
?>
