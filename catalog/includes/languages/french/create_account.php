...
define('TABLE_HEADING_PRIVACY_CONDITIONS', BOX_INFORMATION_PRIVACY);
define('TEXT_PRIVACY_CONDITIONS_DESCRIPTION', 'Veuillez approuver les '.BOX_INFORMATION_PRIVACY.' li&eacute;es &agrave; cette commande en cochant cette case. Les '.BOX_INFORMATION_CONDITIONS.' peuvent &ecirc;tre consult&eacute;es <a target="_blank" href="' . tep_href_link(FILENAME_PRIVACY, '', 'SSL') . '"><u>ici</u></a>.');
define('TEXT_PRIVACY_CONDITIONS_CONFIRM', 'J\'ai lu et j\'accepte les '.BOX_INFORMATION_PRIVACY.'.');

define('NAVBAR_TITLE', 'Créer un compte');

define('HEADING_TITLE', 'Créer un compte');
define('TEXT_ORIGIN_LOGIN', '<font color="#FF0000"><small><b>REMARQUE:</b></font></small> Si vous avez d&eacute;j&agrave; un compte chez nous, veuillez vous connecter à la page d\'<a href="%s"><u>ouverture de compte</u></a>.');
