...
define('HEADING_NEW_CUSTOMER', 'Create Account');
define('TEXT_NEW_CUSTOMER', 'I am a new customer.');
define('TEXT_NEW_CUSTOMER_INTRODUCTION', 'By creating an account at ' . STORE_NAME . ' you will be able to shop faster, be up to date on an orders status, and keep track of the orders you have previously made.<br><br><a href="/privacy-notice/">[Privacy Notice]</a>');

define('HEADING_RETURNING_CUSTOMER', 'Account Login');
...
define('HEADING_CHECKOUT', 'Express Checkout - No Account Needed');
define('TEXT_CHECKOUT_INTRODUCTION', 'Proceed to Checkout without creating an account. By choosing this option you will not be able to review your order status, nor keep track of your previous orders.');
