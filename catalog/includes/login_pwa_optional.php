              ...
              <tr> 
                <td width="33%" height="100%" valign="top" align="center"> <table width="100%" height="100%" border="0" cellpadding="1" cellspacing="0" class="infoBox">
                  <tr> 
                    ...
                    <td valign="top"> 
                      <table width="100%" height="100%" border="0" cellpadding="5" cellspacing="0" class="infoBoxContents">
                        <tr>
                          <td height="20" align="center" valign="top" class="main"><b><?php echo HEADING_CHECKOUT; ?><br>
                            </b></td>
                        </tr>
                        <tr> 
                ...
                <td width="33%" height="100%" valign="top" align="center"> <table width="100%" height="100%" border="0" cellpadding="1" cellspacing="0" class="infoBox">
                  <tr> 
                    ...
                    <td class="main" colspan="2"><?php echo TEXT_RETURNING_CUSTOMER; ?></td>
                        ...
                        <tr align="center"> 
                          <td height="20" colspan="2" class="main"><b><?php echo HEADING_RETURNING_CUSTOMER; ?><br>
                            <br>
                            </b></td>
                        </tr>
                        <tr valign="top"> 
                        ...
                        <tr valign="top"> 
                          <td height="50" class="main"><?php echo ENTRY_EMAIL_ADDRESS; ?><br>
                          <?php echo tep_draw_input_field('email_address','','maxlength="96" size="30"'); ?></td>
                        </tr>
                        <tr valign="top"> 
                          <td height="50" class="main"><?php echo ENTRY_PASSWORD; ?><br>
                          <?php echo tep_draw_password_field('password','','maxlength="40" size="30"'); ?></td>
                        </tr>
                        <tr valign="top"> 
                ...
                <td width="33%" valign="top" align="center"> <table width="100%" height="100%" border="0" cellpadding="1" cellspacing="0" class="infoBox">
                  <tr> 
                      
                    <td valign="top"> 
                      <table width="100%" height="100%" border="0" cellpadding="5" cellspacing="0" class="infoBoxContents">
                        <tr>
                          <td height="20" align="center" valign="top" class="main"><b><?php echo HEADING_NEW_CUSTOMER; ?><br>
                            <br>
                            </b></td>
                        </tr>
                        <tr> 
