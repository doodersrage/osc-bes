...
// ############ Added CCGV Contribution ##########
    ...
    $cart_contents_string .= '<table border="0" width="100%" cellspacing="0" cellpadding="0">';
    // Modified in v5.13 by Rigadin for STS compatibility
// ############ End Added CCGV Contribution ##########  
    //$cart_contents_string = '<table border="0" width="100%" cellspacing="0" cellpadding="0">';
...
// modified by splautz to allow notify of multiple products
      if ((tep_session_is_registered('new_products_id_in_cart')) && (in_array($products[$i]['id'], $new_products_id_in_cart, true))) {
