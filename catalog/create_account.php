...
// added by splautz to maintain cart contents if checking out
      if (sizeof($navigation->snapshot) > 0 && $navigation->snapshot['page'] == FILENAME_CHECKOUT_SHIPPING && sizeof($cart->contents)) $reset_basket = true;
      else $reset_basket = false;

// modified by splautz to maintain cart contents as is if necessary
// restore cart contents
//    $cart->restore_contents();
      $cart->restore_contents($reset_basket);
...
// build the message content
      ...
      $email_text .= CREATE_ACCOUNT_EMAIL_TEXT . EMAIL_WARNING;
...
// ###### End Added CCGV Contribution #########
      tep_mail($name, $email_address, CREATE_ACCOUNT_EMAIL_SUBJECT, $email_text, STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS);
...
?>
              <tr>
                ...
                <td class="main"><?php echo tep_draw_input_field('firstname',$_SESSION['pp_firstname']) . '&nbsp;' . (tep_not_null(ENTRY_FIRST_NAME_TEXT) ? '<span class="inputRequirement">' . ENTRY_FIRST_NAME_TEXT . '</span>': ''); ?></td>
              </tr>
              <tr>
                <td class="main"><?php echo ENTRY_LAST_NAME; ?></td>
                <td class="main"><?php echo tep_draw_input_field('lastname',$_SESSION['pp_lastname']) . '&nbsp;' . (tep_not_null(ENTRY_LAST_NAME_TEXT) ? '<span class="inputRequirement">' . ENTRY_LAST_NAME_TEXT . '</span>': ''); ?></td>
              </tr>
<?php
  if (ACCOUNT_DOB == 'true') {
?>
...
?>
              <tr>
                ...
                <td class="main"><?php echo tep_draw_input_field('email_address',$_SESSION['pp_email']) . '&nbsp;' . (tep_not_null(ENTRY_EMAIL_ADDRESS_TEXT) ? '<span class="inputRequirement">' . ENTRY_EMAIL_ADDRESS_TEXT . '</span>': ''); ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" cellspacing="2" cellpadding="2">
              <tr>
                ...
                <td class="main"><?php echo tep_draw_input_field('company',$_SESSION['pp_business']) . '&nbsp;' . (tep_not_null(ENTRY_COMPANY_TEXT) ? '<span class="inputRequirement">' . ENTRY_COMPANY_TEXT . '</span>': ''); ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" cellspacing="2" cellpadding="2">
              <tr>
                ...
                <td class="main"><?php echo tep_draw_input_field('street_address',($_SESSION['pp_street1'].((ACCOUNT_SUBURB == 'true')?'':(' '.$_SESSION['pp_street2'])))) . '&nbsp;' . (tep_not_null(ENTRY_STREET_ADDRESS_TEXT) ? '<span class="inputRequirement">' . ENTRY_STREET_ADDRESS_TEXT . '</span>': ''); ?></td>
              </tr>
<?php
...
?>
              <tr>
                ...
                <td class="main"><?php echo tep_draw_input_field('suburb',$_SESSION['pp_street2']) . '&nbsp;' . (tep_not_null(ENTRY_SUBURB_TEXT) ? '<span class="inputRequirement">' . ENTRY_SUBURB_TEXT . '</span>': ''); ?></td>
              </tr>
<?php
  }
?>
              <tr>
                ...
                <td class="main"><?php echo tep_draw_input_field('city',$_SESSION['pp_city']) . '&nbsp;' . (tep_not_null(ENTRY_CITY_TEXT) ? '<span class="inputRequirement">' . ENTRY_CITY_TEXT . '</span>': ''); ?></td>
              </tr>
<?php
  if (ACCOUNT_STATE == 'true') {
?>
...
<?php
    if ($process == true) {
      if ($entry_state_has_zones == true) {
        ...
        echo tep_draw_input_field('state',$_SESSION['pp_state']);
      }
    } else {
      echo tep_draw_input_field('state',$_SESSION['pp_state']);
    }
...
?>
              <tr>
                ...
                <td class="main"><?php echo tep_draw_input_field('postcode',$_SESSION['pp_zip']) . '&nbsp;' . (tep_not_null(ENTRY_POST_CODE_TEXT) ? '<span class="inputRequirement">' . ENTRY_POST_CODE_TEXT . '</span>': ''); ?></td>
              </tr>
              <tr>
                <td class="main"><?php echo ENTRY_COUNTRY; ?></td>
                <td class="main"><?php echo tep_get_country_list('country',(tep_not_null($_SESSION['pp_country'])?$_SESSION['pp_country']:STORE_COUNTRY)) . '&nbsp;' . (tep_not_null(ENTRY_COUNTRY_TEXT) ? '<span class="inputRequirement">' . ENTRY_COUNTRY_TEXT . '</span>': ''); ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" cellspacing="2" cellpadding="2">
              <tr>
                ...
                <td class="main"><?php echo tep_draw_input_field('telephone',$_SESSION['pp_phone']) . '&nbsp;' . (tep_not_null(ENTRY_TELEPHONE_NUMBER_TEXT) ? '<span class="inputRequirement">' . ENTRY_TELEPHONE_NUMBER_TEXT . '</span>': ''); ?></td>
              </tr>
              <tr>
