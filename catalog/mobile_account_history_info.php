...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
		<td class="smallText"><?php echo HEADING_ORDER_DATE . ' ' . tep_date_short($order->info['date_purchased']); ?></td>
      </tr>
      <tr>
        <td class="smallText"><?php echo HEADING_ORDER_TOTAL . ' ' . $order->info['total']; ?></td>
      </tr>
      <tr>
...
<?php
  ...
  for ($i=0, $n=sizeof($order->totals); $i<$n; $i++) {
    echo '              <tr>' . "\n" .
         '                <td class="main" align="right" colspan="2" width="100%">' . $order->totals[$i]['title'] . '</td>' . "\n" .
