...
?>
          <tr>
            <td width="<?php echo SMALL_IMAGE_WIDTH + 10; ?>" valign="top" class="main"><?php echo '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products_new['products_id']) . '">' . tep_image(DIR_WS_IMAGES . $products_new['products_image'], $products_new['products_img_alt']?$products_new['products_img_alt']:$products_new['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a>'; ?></td>
            ...
            <td align="right" valign="middle" class="main"><?php echo '<a href="' . tep_href_link(FILENAME_PRODUCTS_NEW, tep_get_all_get_params(array('action')) . 'action=buy_now' . (!empty($products_new['products_affiliate_url'])?'_aff':'') . '&products_id=' . $products_new['products_id']) . '">' . (empty($products_new['products_affiliate_url'])?tep_image_button('button_in_cart.gif', IMAGE_BUTTON_IN_CART):tep_image_button('affiliate_buy_now.gif', IMAGE_BUTTON_BUY_NOW)) . '</a>'; ?></td>
          </tr>
          <tr>
