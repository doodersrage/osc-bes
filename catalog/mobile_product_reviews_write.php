...
if (!tep_session_is_registered('customer_id')) {
  ...
  if (isset($HTTP_GET_VARS['action']) && ($HTTP_GET_VARS['action'] == 'process')) {
    ...
    if ($error == false) {
      ...
      tep_redirect(tep_mobile_link(FILENAME_PRODUCT_REVIEWS, tep_get_all_get_params(array('action', 'module'))));
    }
  }
...
?>
    <table border="0">
      ...
      <tr>
		<td class="main" colspan="2"><?php echo tep_mobile_button(IMAGE_BUTTON_CONTINUE); ?></td>
      </tr>
    </table>
 </form>
