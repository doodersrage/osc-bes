...
// modified by splautz to put sitemaps in root
//		$this->savepath = DIR_FS_CATALOG;
		$this->savepath = $_SERVER['DOCUMENT_ROOT'] . '/';
 ...
 */	
	...
	function GenerateProductSitemap(){
		...
		$sql = "SELECT distinct p.products_id as pID, p.products_date_added as date_added, p.products_last_modified as last_mod, p.products_ordered 

			    FROM " . TABLE_PRODUCTS . " p , " . TABLE_PRODUCTS_TO_CATEGORIES . " p2c, " . TABLE_CATEGORIES . " c 

				WHERE p.products_status = '1' and p.products_id = p2c.products_id and c.categories_id = p2c.categories_id and c.categories_status = '1' 
