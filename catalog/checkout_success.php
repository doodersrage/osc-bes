...
// modified by splautz to allow obtaining more order information for affliate calls
...
<?php
  echo TEXT_SEE_ORDERS . '<br><br>' . TEXT_CONTACT_STORE_OWNER . '<br><br>';
  if ($global['global_product_notifications'] != '1') {
    echo '<br>' . TEXT_NOTIFY_PRODUCTS . '<br><p class="productsNotifications">';
