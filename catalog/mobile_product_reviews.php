...
?>
			  <tr>
              	<td class="main"><?php echo '<a href="' . tep_mobile_link(FILENAME_PRODUCT_REVIEWS, 'products_id=' . $product_info['products_id'] . '&reviews_id=' . $reviews['reviews_id']) . '"><u><b>' . sprintf(TEXT_REVIEW_BY, tep_output_string_protected($reviews['customers_name'])) . '</b></u></a>'; ?></td>
              </tr>
			  <tr>
                <td class="smallText"><?php echo sprintf(TEXT_REVIEW_DATE_ADDED, tep_date_long($reviews['date_added'])); ?></td>
              </tr>
              <tr>
                <td class="review">
                <?php
...
?>
              <tr>
                        <td class="main"><?php echo '<a href="' . tep_mobile_link(FILENAME_PRODUCT_REVIEWS_WRITE, tep_get_all_get_params(array('module'))) . '">' . tep_mobile_button(IMAGE_BUTTON_WRITE_REVIEW) . '</a>'; ?></td>
              </tr>
            </table></td>
          </td>
        </table></td>
