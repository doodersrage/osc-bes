...
// if no shipping destination address was selected, use their own address as default
  ...
  $addresses_count = tep_count_customer_address_book_entries();
	...
	$headerTitle->write();
?>
<?php echo tep_draw_form('checkout_address', tep_mobile_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL'), 'post', 'onSubmit="return check_form_optional(checkout_address);"'); ?>
...
?>
      <tr><td>
	      ...
	      <tr>
	        <td class="smallText"><?php echo TEXT_SELECTED_SHIPPING_DESTINATION; ?></td>
	      </tr>
	      <tr>
	        <td class="main"><?php echo tep_address_label($customer_id, $sendto, true, ' ', '<br>'); ?></td>
	      </tr>
	  </table>
      </td></tr>
      <tr>
...
?>
      <tr><td>
	      ...
	      <tr>
			<td class="smallText"><?php echo TEXT_SELECT_OTHER_SHIPPING_DESTINATION; ?></td>
	      </tr>
	      <tr>
      		<td>
      			<table border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
      	<td>
        	<table border="0" width="100%" cellspacing="0" cellpadding="2">
	          <tr>
	            <td class="main" colspan="2"><b><?php echo TABLE_HEADING_NEW_SHIPPING_ADDRESS; ?></b></td>
    	      </tr>
	          <tr>
	            <td class="smallText" colspan="2"><?php echo TEXT_CREATE_NEW_SHIPPING_ADDRESS; ?></td>
    	      </tr>
			  <tr>
