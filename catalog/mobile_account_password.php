...
$headerTitle->write();
?>
<?php echo tep_draw_form('account_password', tep_mobile_link(FILENAME_ACCOUNT_PASSWORD, '', 'SSL'), 'post', 'onSubmit="return check_form(account_password);"') . tep_draw_hidden_field('action', 'process'); ?>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    ...
                    <td class="main"><?php echo tep_draw_password_field('password_current'); ?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="main"><?php echo tep_draw_password_field('password_new'); ?></td>
                  </tr>
                  <tr>
                    <td class="main"><?php echo ENTRY_PASSWORD_CONFIRMATION; ?></td>
                    <td class="main"><?php echo tep_draw_password_field('password_confirmation'); ?></td>
                  </tr>
        </table></td>
      </tr>
      <tr>
