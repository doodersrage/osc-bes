...
class splitPageResultsAjax extends splitPageResults {
	function display_ajax_msg() {
		if($this->number_of_pages > 1)
			$ret = '<td onClick="showMoreResults()"><table class="categories"><tr><td class="categories">' . 'Show More Results' . '</td><td align="right" class="categories"><img height="30" border="0" width="30" src="images/arrow_select.png" alt=""/></td></tr></table></td>';
		return $ret;
	}
